...
public class DriverUtil {
	...
	/*public static AndroidDriver<AndroidElement> getMobileApp(){
		...
		try {
			...
			capabilities.setCapability(MobileCapabilityType.DEVICE_NAME,MobileKeywords.GetValue("ID"));
			capabilities.setCapability(MobileCapabilityType.PLATFORM_VERSION, MobileKeywords.GetValue("Version"));
			...
			capabilities.setCapability("app",MobileKeywords.GetValue("apkFilePath"));
		...
		try {
			...
			while(2>1)
			{
				try
				{
					...
					Thread.sleep(10000);
					MobileKeywords.explicitWaitForElementforGivenTime(MoneyControlAppPage.marketsbutton, MoneyControlAppPage.type_xpath, 10);
					System.out.println("menu button visible");
					//driver.findElement(By.xpath("//*[@class='android.widget.RelativeLayout'][@index='4']")).click();
					break;
				}
				catch(Exception e)
				{
