...
public class MoneyControlAppPage extends MobileKeywords {
		...
		try {
			...
			for (int i = 0; i < mutualfunds_list.length; i++) {
				...
				AndroidElement a = GlobalUtil.getMDriver()
						.findElement(By.xpath(MoneyControlAppPage.enter_scheme_name_mutualfunds));
	...
	public static void enterNscStockName(String name) {
		try {
			System.out.println("Stock is : " + name);
			GlobalUtil.getMDriver().findElement(By.xpath(MoneyControlAppPage.nse_search1)).sendKeys(name);
			Thread.sleep(4000);
	...
	public static void user_checks_for_top5news_in_homepage() {
		AndroidElement ae = GlobalUtil.getMDriver().findElement(By.xpath(
